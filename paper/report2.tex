...
\caption{The first four principal components for subject 011, 0-back}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[scale=0.4]{../results/sub011_task003_design_matrix.png}
\caption{The design matrix for subject 011, 2-back}
\end{figure}
...
\caption{K-means result for $k=6$ on smoothed standard fMRI data, sub011, 0-back}
\end{figure} 
