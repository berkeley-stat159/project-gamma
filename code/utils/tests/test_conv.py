...
def test_main():
  task_fname = os.path.join(os.path.dirname(__file__), "test_data", "test_cond003.txt")
  actual_main = conv_main(10, task_fname, 1)
  expected_main = array([  3.46786253e-05,3.90603366e-03, 1.65702768e-02,2.96511947e-02, 3.50123290e-02, 3.24253327e-02, 2.45289911e-02, 1.51282388e-02, 6.69815333e-03, 4.15265073e-04])
  assert_almost_equal(actual_std, expected_std )
