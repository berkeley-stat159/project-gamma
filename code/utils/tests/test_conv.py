...
def test_std():
  task_fname = os.path.join(os.path.dirname(__file__), "test_data", "test_cond003.txt")
  actual_target_std = conv.conv_std(10, task_fname, 1)
  expected_target_std = np.array([ 0., -0.00030452, -0.00358456, -0.01000677, -0.01545791,-0.01714284, -0.01517165, -0.01111583, -0.00658934, -0.00265908])
  assert_almost_equal(actual_target_std, expected_target_std )
